        ...
        if (!alarm.silent) {
            ...
            try {
                ...
                try {
                    ...
                    mMediaPlayer.reset();
                    // FIXME
                    Toast.makeText(this, "Fallback ringtone has been disabled.", Toast.LENGTH_SHORT).show();
//                    setDataSourceFromResource(getResources(), mMediaPlayer,
//                            com.android.internal.R.raw.fallbackring);
        ...
        if (alarm.vibrate) {
        	// TODO [pjl] If Bluetooth connected to the remote wearable device, send vibrate call 
        	//      to that device and don't vibrate on the phone.
        	// 	    If no Bluetooth connection, then vibrate on the phone.
        	
        	// Vibrate on the remote wearable device
        	   // TODO insert call to LiveView device
