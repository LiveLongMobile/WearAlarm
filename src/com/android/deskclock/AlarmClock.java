...
public class AlarmClock extends Activity implements OnItemClickListener {
    ...
    // intro dialog to be shown at application startup
    public void introDialog() {
    	// load the view
    	LayoutInflater li = LayoutInflater.from(this);
    	View view = li.inflate(R.layout.intro, null);
    	
    	// set all the TextViews
    	TextView textView = (TextView) view.findViewById(R.id.IntroTextView);
    	textView.setText(R.string.intro_text_header);
//        TextView textViewInstructions = (TextView) view.findViewById(R.id.IntroTextViewInstructions);
//    	textViewInstructions.setText(R.string.intro_text_instructions);
        TextView textViewStep1 = (TextView) view.findViewById(R.id.IntroTextViewStep1);
    	textViewStep1.setText(R.string.intro_text_step1);
        TextView textViewStep2 = (TextView) view.findViewById(R.id.IntroTextViewStep2);
    	textViewStep2.setText(R.string.intro_text_step2);
        TextView textViewStep3 = (TextView) view.findViewById(R.id.IntroTextViewStep3);
    	textViewStep3.setText(R.string.intro_text_step3);
        TextView textViewTips = (TextView) view.findViewById(R.id.IntroTextViewTips);
    	textViewTips.setText(R.string.intro_text_tips);
        TextView textViewTip1 = (TextView) view.findViewById(R.id.IntroTextViewTip1);
    	textViewTip1.setText(R.string.intro_text_tip1);
        TextView textViewTip2 = (TextView) view.findViewById(R.id.IntroTextViewTip2);
    	textViewTip2.setText(R.string.intro_text_tip2);
    	
    	AlertDialog.Builder builder = new AlertDialog.Builder(this);
    	builder.setTitle(R.string.intro_text_title);
    	builder.setView(view);    	    	
    	
    	PromptListener pl = new PromptListener();
    	builder.setNegativeButton("Close", pl);
    	
    	AlertDialog ad = builder.create();
    	ad.show();
    	
/*    	// TODO add checkbox to intro dialog, connect it to this....
    	SharedPreferences introPrefs = getSharedPreferences("intro_dialog_prefs", 0);
//    	boolean introPrefsChk = introPrefs.getBoolean(this.getResources().getString(R.string.show_intro), true);
    	String introPrefsChk = introPrefs.getString(this.getString(R.string.show_intro), "false");
    	Toast.makeText(this, introPrefsChk, Toast.LENGTH_SHORT).show();
*/    }

    // listener for introDialog
    public class PromptListener implements android.content.DialogInterface.OnClickListener
    {

		@Override
		public void onClick(DialogInterface dialog, int which) {
			// TODO insert handling for future checkbox so that 
			//      user can select to display dialog next time or not
